...
const Contact = () => {
	const image = useStaticQuery(graphql`
		query {
			...
			pollen: file(relativePath: { eq: "thumbnails/logos/pollen.png" }) {
				childImageSharp {
					fixed(width: 100) {
						...GatsbyImageSharpFixed
					}
			...
			<Layout title={siteTitle}>
				...
				>
					...
					<LogoBox
						...
						five={image.pollen.childImageSharp.fxied}
						fiveAlt="Pollen"
						six={image.pollen.childImageSharp.fxied}
						sixAlt="Pollen"
					/> */}
				</article>
				...
				{/* <iframe
					width="100%"
					height="1000"
					src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2FMH3lhoxQjFYhzR5rkzo5ny%2FNimesh-Reghunandanan-CV%3Fnode-id%3D0%253A1"
					allowfullscreen
				></iframe> */}
			</Layout>
		</div>
